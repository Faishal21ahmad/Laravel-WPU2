    ...
    <div class="card mb-3">
        ...
        <div class="card-body text-center">
            ...
            <p>
                ...
                By. <a href="/posts?author={{ $posts[0]->author->username }}"  class="text-decoration-none">{{ $posts[0]->author->name }}</a> in <a href="/posts?kategori={{ $posts[0]->kategori->slug }}" class="text-decoration-none">{{ $posts[0]->kategori->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}
                </small>
            </p>
